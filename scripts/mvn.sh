...
#
# Run Maven in a container to ensure a consistent build environment on
# machines that don't have Maven/JDK installed locally. Good for CI and
# developer machines alike.
